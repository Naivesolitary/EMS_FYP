  ...
  const testimonials = [
    {
      ...
      quote:
        "EventFlow has transformed how I manage my events. The platform is intuitive and the templates save me hours of work!",
      rating: "★★★★★",
    },
    {
      name: "Michael Chen",
      ...
      quote:
        "I love how easy it is to find and register for events. The ticket management system is seamless and user-friendly.",
      rating: "★★★★★",
    },
    {
      ...
      quote:
        "The analytics and reporting features have been invaluable for our corporate events. Highly recommend for any event professional.",
      rating: "★★★★★",
    },
  ];
              ...
              <div className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div className="sm:text-center lg:text-left">
                  ...
                  <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                    Your all-in-one platform for finding, managing, and creating
                    memorable events. Join us today!
                  </p>
